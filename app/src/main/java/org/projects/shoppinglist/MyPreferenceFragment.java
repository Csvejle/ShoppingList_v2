...
public class MyPreferenceFragment extends PreferenceFragment {
	...
	private static String SETTINGS_GENDERKEY = "notification";
	private static String SETTINGS_NAMEKEY = "name";
	private static String SETTINGS_DATETIMEKEY = "date";

	//note these are static methods - meaning they always exists
	//so we do not have to create an instance of this class to
	//get the values.
	public static boolean wantNotifications(Context context)
	{
		return PreferenceManager.getDefaultSharedPreferences(context).getBoolean(SETTINGS_GENDERKEY, false);
	}
	...
	{
		return DatePreference.getCurrentDate(context);
	}
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        final DatePreference dp = (DatePreference) findPreference(SETTINGS_DATETIMEKEY);

		//Ved præference ændring
